...
//宏定义------------------------------------
#define _PKG_MAX_LENGTH     MAXMSGLEN  //每个包的最大长度【包头+包体】不超过这个数字，为了留出一些空间，实际上编码是，包头+包体长度必须不大于 这个值-1000【127000】
...
#define _DATA_BUFSIZE_       sizeof(MSGHEAD) //因为我要先收包头，我希望定义一个固定大小的数组专门用来收包头
