...
#define INDEXSIZE     7177 	// ����Ϊ�����������dq.h�еĶ���һ��

#define MUTEXSIZE	  64	// һ��BOARD��DB�ж�д����������������2��n���ݣ������dq.h�еĶ���һ��
...
//DllImport BOOL __cdecl ReadL1Tag(HANDLE hServer, LPCTSTR lpItemName, char*, int buffSize, DWORD * error);	//L1��֧��UNICODE�ַ���д������ֻ����char*
